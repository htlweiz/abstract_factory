...
class JsonMessage(AbstractMessage):
    def __init__(self, filename):
        ...
        self.data = None
        self.initialize()  # Führen Sie die Initialisierung bei der Erstellung einer Instanz aus
    ...
    def postMessage(self, header: str, body: str) -> None:
        ...
        self.save()  # Speichern Sie die aktualisierten Daten nach dem Hinzufügen einer neuen Nachricht